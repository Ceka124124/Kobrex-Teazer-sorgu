...
export async function GET(request: NextRequest) {
  try {
    ...
    const apiUrl = "https://worlds-honolulu-starring-luggage.trycloudflare.com/tcpro.php"
    ...
    // JSON parse etmeye çalış, başarısız olursa raw text döndür
    try {
    ...
    console.error("TC Pro API Error:", error)
