...
import { ArrowLeft, Search, Smile, AlertCircle, CheckCircle, Copy } from "lucide-react"
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs"

export default function Meme1Page() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`/api/services/meme1?text=${encodeURIComponent(text)}`)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">Komik resim oluşturun</p>
          </div>
        ...
        <Card className="bg-slate-800 border-slate-700 mb-6">
          ...
          <CardContent className="space-y-4">
            <div>
              <label className="text-sm text-slate-300 mb-2 block">Metin</label>
              <Input
                type="text"
                placeholder="Meme metni yazın..."
                value={text}
                onChange={(e) => {
