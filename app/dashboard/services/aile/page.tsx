...
import { ArrowLeft, Search, Heart, AlertCircle, CheckCircle, Copy } from "lucide-react"
...
export default function AilePage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`/api/services/aile?tc=${tc}`)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">TC Kimlik numarası ile aile bilgilerini sorgulayın</p>
          </div>
