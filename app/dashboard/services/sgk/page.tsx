...
export default function GptPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`https://worlds-honolulu-starring-luggage.trycloudflare.com/sgk.php?tc=${encodeURIComponent(question)}`)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">SGK 🏗️ Sorgulamak için TC yazın...</p>
          </div>
        ...
        <Card className="bg-slate-800 border-slate-700 mb-6">
          ...
          <CardContent className="space-y-4">
            <div>
              <label className="text-sm text-slate-300 mb-2 block"></label>
              <Input
                type="text"
                placeholder="TC yazın..."
                value={question}
                onChange={(e) => {
