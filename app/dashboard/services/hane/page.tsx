...
export default function HanePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const response = await fetch("/api/services/hane", {
        method: "POST",
      ...
      if (data.success) {
        ...
        toast({
          title: "Başarılı",
          description: "Hane sorgusu tamamlandı",
        })
      } else {
        toast({
          title: "Hata",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">TC Kimlik numarası ile hane bilgilerini sorgulayın</p>
          </div>
