...
import { ArrowLeft, Search, MessageSquare, AlertCircle, CheckCircle, Copy } from "lucide-react"
...
export default function GptPage() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`https://tissue-non-nobody-checking.trycloudflare.com/log.php?log=${encodeURIComponent(question)}`)
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">Siteden Log Çekmek İçin Sitenizi Yazın</p>
          </div>
        ...
        <Card className="bg-slate-800 border-slate-700 mb-6">
          ...
          <CardContent className="space-y-4">
            <div>
              <label className="text-sm text-slate-300 mb-2 block">Sorunuz</label>
              <Input
                type="text"
                placeholder="Sitenizi Yazın..."
                value={question}
                onChange={(e) => {
