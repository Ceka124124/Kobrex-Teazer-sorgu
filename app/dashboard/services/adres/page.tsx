...
import { Copy, Search, MapPin } from "lucide-react"
...
export default function AdresPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const response = await fetch("/api/services/adres", {
        method: "POST",
      ...
      if (data.success) {
        ...
        toast({
          title: "Başarılı",
          description: "Adres sorgusu tamamlandı",
        })
      } else {
        toast({
          title: "Hata",
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">TC Kimlik numarası ile temel adres bilgilerini sorgulayın</p>
          </div>
